  ...
  return (
    <div className="min-h-screen bg-[#080c18] text-gray-100 overflow-x-hidden font-sans">
      ...
      <div className="bg-white relative">
        {/* Gradient orbs for light sections */}
        <div className="pointer-events-none absolute inset-0 overflow-hidden -z-0">
          <div className="absolute rounded-full top-[4%] -left-[8%] w-[37.5rem] h-[37.5rem] bg-indigo-400/[.11] blur-[8.75rem]" />
          <div className="absolute rounded-full top-[38%] -right-[8%] w-[31.25rem] h-[31.25rem] bg-purple-400/[.09] blur-[8.125rem]" />
          <div className="absolute rounded-full bottom-[18%] left-[28%] w-[26.25rem] h-[26.25rem] bg-indigo-500/[.07] blur-[7.5rem]" />
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-16">
                ...
                <div className="space-y-6">
                  {education.map((edu, i) => (
                    <div key={i} className="light-card rounded-xl p-6">
                      <p className="font-mono text-xs text-gray-400 mb-2">{edu.year}</p>
                      <h3 className="font-semibold text-lg mb-1 text-gray-900">{edu.degree}</h3>
              ...
              <div>
                ...
                <h2 className="text-3xl font-bold mb-8 text-gray-900">Certifications</h2>
                <div className="space-y-4">
                  {certifications.map((cert, i) => (
                    ...
                    >
                      ...
                      <span className="font-mono text-xs text-gray-400">{cert.period}</span>
                    </div>
                  ))}
                </div>
              </div>
